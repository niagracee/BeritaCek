package com.niyagrace.beritacek;
...
import com.niyagrace.beritacek.response.BeritaItem;
...
class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "http://192.168.1.4/simple-api-portal-berita-master/images/" + berita.get(position).getFoto();
